...
export const Modal: FC<BookProps> = ({
  bookData,
  onChange,
  onSubmit,
  disableEdit,
    ...
    <form className="space-y-8">
      ...
      {!disableEdit && (
        <button
          type="submit"
          onClick={clickSubmit}
          className="w-full text-center text-white inline-flex items-center bg-red-700 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-red-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
        >
          Save
        </button>
      )}
