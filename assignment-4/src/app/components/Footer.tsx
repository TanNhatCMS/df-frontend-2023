...
export const Footer: FC<BookProps> = ({ page, perPage, total, totalPages }) => {
  ...
  return (
    <>
      ...
      <footer className="font-semibold text-center text-gray-900 dark:text-white">
        &copy; 2023 || Made with TânNhậtCMS||
        <a href="https://github.com/TanNhatCMS/df-frontend-2023/tree/main/assignment-4">
          Source code
        </a>
      </footer>
    </>
